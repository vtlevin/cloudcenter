...
#
agentVersionId="4.5.0.0GA.4.5.8.2700.47aa83e6a6e458eff6190d5d1e2fd4fe671f2131"
...
rpmBaseName="appdynamics-php-agent-4.5.0.0-1.x86_64.rpm"
tarballBaseName=""
...
[ -n "${APPD_PHP_PATH}" ] && export APPD_PHP_PATH

...
environment_variables = get_cliqr_env_variables(['CliqrTier_siwapp_app_HOSTNAME','CliqrTier_siwapp_apacheproxy_app_PUBLIC_IP'])
...
SIWAPP_FRONTEND_PROXY_URL = 'http://' + environment_variables["CliqrTier_siwapp_apacheproxy_app_PUBLIC_IP"]

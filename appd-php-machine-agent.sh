...
sudo curl -o /opt/appdynamics/machine-agent/conf/controller-info-php.xml https://raw.githubusercontent.com/vtlevin/cloudcenter/master/controller-info-xml

sudo mv /opt/appdynamics/machine-agent/conf/controller-info-php.xml /opt/appdynamics/machine-agent/conf/controller-info.xml
